...
class LocalHSM(AbstractHSM):
    ...
    def replica_pubkeys_wrap(self):
        return self._filter_replica_keys(
            self.find_keys(objclass=_ipap11helper.KEY_CLASS_PUBLIC_KEY, cka_wrap=True)
        )
    ...
    def master_keys(self):
        ...
        for key in keys.values():
            ...
            assert key["ipk11label"] == prefix, (
                ...
                % (str_hexlify(key["ipk11id"]), str(key["ipk11label"]), prefix)
            )
