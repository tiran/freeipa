...
from ipalib import Flag, Int, Password, Str, Bool, StrEnum, DateTime, DNParam
...
baseuser_output_params = (Flag("has_keytab", label=_("Kerberos keys available"),),)
...
class baseuser(LDAPObject):
    ...
    takes_params = (
        ...
        Str("givenname", cli_name="first", label=_("First name"),),
        Str("sn", cli_name="last", label=_("Last name"),),
        Str(
            "cn",
            label=_("Full name"),
        ...
        Str("street?", cli_name="street", label=_("Street address"),),
        Str("l?", cli_name="city", label=_("City"),),
        Str("st?", cli_name="state", label=_("State/Province"),),
        Str("postalcode?", label=_("ZIP"),),
        ...
        Str("facsimiletelephonenumber*", cli_name="fax", label=_("Fax Number"),),
        Str("ou?", cli_name="orgunit", label=_("Org. Unit"),),
        Str("title?", label=_("Job Title"),),
        # keep backward compatibility using single value manager option
        Str("manager?", label=_("Manager"),),
        Str("carlicense*", label=_("Car License"),),
        Str(
            "ipasshpubkey*",
            validate_sshpubkey,
            cli_name="sshpubkey",
        ...
        Str("departmentnumber*", label=_("Department Number"),),
        Str("employeenumber?", label=_("Employee Number"),),
        Str("employeetype?", label=_("Employee Type"),),
        Str(
            "preferredlanguage?",
...
class baseuser_add(LDAPCreate):
    ...
    def pre_common_callback(self, ldap, dn, entry_attrs, attrs_list, *keys, **options):
        ...
        if entry_attrs.get("ipatokenradiususername", None):
            add_missing_object_class(
                ldap, u"ipatokenradiusproxyuser", dn, entry_attrs, update=False
            )
