...
class hostgroup(LDAPObject):
    ...
    managed_permissions = {
        ...
        "System: Read Hostgroup Membership": {
            ...
            "ipapermbindruletype": "all",
            "ipapermright": {"read", "search", "compare"},
            "ipapermdefaultattr": {"member", "memberof", "memberuser", "memberhost",},
        },
    ...
    def pre_callback(self, ldap, dn, *keys, **options):
        if keys[0] in PROTECTED_HOSTGROUPS:
            raise errors.ProtectedEntryError(
                label=_(u"hostgroup"), key=keys[0], reason=_(u"privileged hostgroup")
            )
...
class hostgroup_add_member_manager(LDAPAddMember):
    ...
    has_output_params = LDAPAddMember.has_output_params + hostgroup_output_params
...
class hostgroup_remove_member_manager(LDAPRemoveMember):
    ...
    has_output_params = LDAPRemoveMember.has_output_params + hostgroup_output_params
    member_attributes = ["membermanager"]
