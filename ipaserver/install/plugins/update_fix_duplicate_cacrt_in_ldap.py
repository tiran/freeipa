    ...
    def execute(self, **options):
        ...
        for entry in result:
            ...
            try:
                ...
                logger.warning("Failed to remove the duplicate %s: %s", entry.dn, e)
