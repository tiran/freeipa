...
class test_set_directive:
    def test_set_directive(self):
        ...
        try:
            ...
            directivesetter.set_directive(filename, "foo", "3", False, "=", "#")
...
class test_get_directive:
    def test_get_directive(self, tmpdir):
        ...
        assert "1" == directivesetter.get_directive(
            str(configfile), "foo", separator="="
        )
        assert "2" == directivesetter.get_directive(
