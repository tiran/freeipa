...
FILLED_LOGIN_FORM = {
    ...
    "rows": [
        ("username", "Username", True, True, "text", "username", PKEY, "Username"),
        (
            "password",
            "Password",
            True,
    ...
    "required_msg": [("Username: Required field",), ("Password: Required field",),],
}
...
RESET_AND_LOGIN_FORM = {
    ...
    # input_text, placeholder
    "rows": [
        ("username_r", "Username", False, False, None, "username_r", PKEY, None),
        (
            "current_password",
            "Current Password",
            False,
        ...
        ("otp", "OTP", False, True, "password", "otp", "", "One-Time-Password"),
        (
            "new_password",
            "New Password",
            True,
...
RESET_PASSWORD_FORM = {
    ...
    # input_text, placeholder
    "rows": [
        ("username", "Username", True, True, "text", "username", "", "Username"),
        (
            "current_password",
            "Current Password",
            True,
...
EMPTY_LOGIN_FORM = {
    ...
    # input_text, placeholder
    "rows": [
        ("username", "Username", False, True, "text", "username", "", "Username"),
        (
            "password",
            "Password",
            False,
    ...
    "required_msg": [("Authentication with Kerberos failed",),],
}
...
LOGIN_FORM = {
    ...
    "required_msg": [("Password: Required field",),],
}
