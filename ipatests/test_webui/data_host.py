...
empty_hostname = {
    "pkey": "empty_hostname",
    "add": [("textbox", "hostname", ""),],
}

empty_domain = {
    "pkey": "empty_domain",
    "add": [("textbox", "hostname", "itest-empty-domain"), ("textbox", "dnszone", ""),],
}

hostname_tilde = {
    "pkey": "tilde_hostname",
    "add": [("textbox", "hostname", "~tilde"),],
}

hostname_dash = {
    "pkey": "dash_hostname",
    "add": [("textbox", "hostname", "-dash"),],
}

hostname_leading_space = {
    "pkey": "leading_space",
    "add": [("textbox", "hostname", " leading_space"),],
}

hostname_trailing_space = {
    "pkey": "trailing_space",
    "add": [("textbox", "hostname", "trailing_space "),],
}
...
ssh_rsa = (
    "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQCnAOLat"
...
ssh_dsa = (
    "ssh-dss AAAAB3NzaC1kc3MAAACBAO3OqwC1eNedXVJ57"
