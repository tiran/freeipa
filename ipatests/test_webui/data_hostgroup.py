...
DATA = {
    ...
    "mod": [("textarea", "description", "test-hostgroup desc modified"),],
}
...
DATA2 = {
    ...
    "mod": [("textarea", "description", "test-hostgroup2 desc modified"),],
}
...
DATA3 = {
    ...
    "mod": [("textarea", "description", "test-hostgroup3 desc modified"),],
}
...
DATA4 = {
    ...
    "mod": [("textarea", "description", "test-hostgroup4 desc modified"),],
}
...
DATA5 = {
    ...
    "mod": [("textarea", "description", "test-hostgroup5 desc modified"),],
}
...
DATA8 = {
    "pkey": PKEY8,
    "add": [("textbox", "cn", PKEY8), ("textarea", "description", DKEY8),],
}
