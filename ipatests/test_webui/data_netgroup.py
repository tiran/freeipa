...
DATA = {
    ...
    "mod": [("textarea", "description", "test-netgroup desc modified"),],
}
...
DATA2 = {
    ...
    "mod": [("textarea", "description", "test-netgroup2 desc modified"),],
}
...
DATA_SINGLE_CHAR = {
    ...
    "add": [
        ("textbox", "cn", PKEY7),
        ("textarea", "description", "Trying to add single character netgroup" " name"),
    ],
}
...
DATA8 = {
    ...
    "mod": [("textarea", "description", "description modified for testing buttons"),],
}
