...
DATA_SIZE_LIMIT_LETTER = {
    "mod": [("textbox", "ipasearchrecordslimit", "a"),],
}

DATA_SIZE_LIMIT_SPACE = {
    "mod": [("textbox", "ipasearchrecordslimit", " space"),],
}

DATA_SIZE_LIMIT_NEG = {
    "mod": [("textbox", "ipasearchrecordslimit", "-2"),],
}

DATA_TIME_LIMIT_LETTER = {
    "mod": [("textbox", "ipasearchtimelimit", "a"),],
}

DATA_TIME_LIMIT_SPACE = {
    "mod": [("textbox", "ipasearchtimelimit", " space"),],
}

DATA_TIME_LIMIT_NEG = {
    "mod": [("textbox", "ipasearchtimelimit", "-2"),],
}
