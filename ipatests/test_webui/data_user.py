...
DATA = {
    ...
    "mod": [
        ...
        ("multivalued", "pager", [("add", "1234567"), ("add", "7654321"),]),
        ("multivalued", "mobile", [("add", "001123456"), ("add", "001654321"),]),
        (
            "multivalued",
            "facsimiletelephonenumber",
            [("add", "1122334"), ("add", "4332211"),],
        ),
        ("textbox", "street", "Wonderwall ave."),
        ("textbox", "l", "Atlantis"),
        ("textbox", "st", "Universe"),
        ("textbox", "postalcode", "61600"),
        ("multivalued", "carlicense", [("add", "ZLA-1336"),]),
        ("textbox", "ou", "QE"),
    ...
    "mod_v": [
        ...
        ("multivalued", "mail", ["one@ipa.test", "two@ipa.test", "three@ipa.test"]),
