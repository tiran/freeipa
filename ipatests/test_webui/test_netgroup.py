...
class test_netgroup(UI_driver):
    ...
    def test_basic_workflows(self):
        ...
        self.add_record(
            netgroup.ENTITY,
            [netgroup.DATA, netgroup.DATA2, netgroup.DATA3, netgroup.DATA4],
        )
        # search record
    ...
    def test_unsaved_changes(self):
        ...
        """
        self.init_app()
        self.add_record(netgroup.ENTITY, netgroup.DATA8, dialog_btn="add_and_edit")
    ...
    def test_add_members(self):
        ...
        self.add_associations(
            [netgroup.PKEY, netgroup.PKEY8], "memberof_netgroup", delete=True
        )
