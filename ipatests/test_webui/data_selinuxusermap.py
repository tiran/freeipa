...
DATA = {
    "pkey": PKEY,
    "add": [("textbox", "cn", PKEY), ("textbox", "ipaselinuxuser", selinuxuser1),],
    "mod": [("textarea", "description", "itest-selinuxusermap desc"),],
}

PKEY2 = "itest-selinuxusermap2"
DATA2 = {
    "pkey": PKEY2,
    "add": [("textbox", "cn", PKEY2), ("textbox", "ipaselinuxuser", selinuxuser2),],
    "mod": [("textarea", "description", "itest-selinuxusermap desc2"),],
}
...
DATA_MCS_COMMAS = {
    ...
    "add": [
        ...
        (
            "textbox",
            "ipaselinuxuser",
            "foo:s0-{}:c0,{},{}".format(second_mls_level, second_mcs_level, mcs_range),
        ),
    ],
}
...
DATA_MLS_SINGLE_VAL = {
    ...
    "add": [
        ...
        ("textbox", "ipaselinuxuser", "foo:s0-s0:c0.c{}".format(selinux_mcs_max)),
    ],
}
...
DATA_INVALID_MLS = {
    ...
    "add": [("textbox", "cn", PKEY_INVALID_MLS), ("textbox", "ipaselinuxuser", "foo"),],
}

PKEY_FIELD_REQUIRED = "itest-selinuxusermap_without_SELinux_user"
DATA_FIELD_REQUIRED = {
    "pkey": PKEY_FIELD_REQUIRED,
    "add": [("textbox", "cn", PKEY_FIELD_REQUIRED),],
}
