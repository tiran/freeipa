...
DATA = {
    ...
    "mod": [("textarea", "description", "test-group desc modified"),],
}

PKEY2 = "itest-group2"
DATA2 = {
    "pkey": PKEY2,
    "add": [("textbox", "cn", PKEY2), ("textarea", "description", "test-group2 desc"),],
}

PKEY3 = "itest-group3"
DATA3 = {
    "pkey": PKEY3,
    "add": [("textbox", "cn", PKEY3), ("textarea", "description", "test-group3 desc"),],
}

PKEY4 = "itest-group4"
DATA4 = {
    "pkey": PKEY4,
    "add": [("textbox", "cn", PKEY4), ("textarea", "description", "test-group4 desc"),],
}

PKEY5 = "itest-group5"
DATA5 = {
    "pkey": PKEY5,
    "add": [("textbox", "cn", PKEY5), ("textarea", "description", "test-group5 desc"),],
}
...
DATA7 = {
    "pkey": PKEY7,
    "add": [("textbox", "cn", PKEY7), ("textarea", "description", "Empty Group name"),],
}
