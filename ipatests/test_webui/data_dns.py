...
ZONE_DATA = {
    "pkey": ZONE_PKEY,
    "add": [("textbox", "idnsname", ZONE_PKEY),],
    "mod": [("checkbox", "idnsallowsyncptr", "checked"),],
}
...
FORWARD_ZONE_DATA = {
    ...
    "add": [
        ...
        ("multivalued", "idnsforwarders", [("add", "192.168.2.1"),]),
        ("radio", "idnsforwardpolicy", "only"),
    ],
    "mod": [
        ("multivalued", "idnsforwarders", [("add", "192.168.3.1"),]),
...
RECORD_MOD_DATA = {"fields": [("textbox", "a_part_ip_address", "192.168.1.11"),]}
