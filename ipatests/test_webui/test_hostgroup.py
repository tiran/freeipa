...
class test_hostgroup(UI_driver):
    ...
    def test_crud(self):
        ...
        self.init_app()
        self.basic_crud(
            hostgroup.ENTITY, hostgroup.DATA, default_facet=hostgroup.DEFAULT_FACET
        )
    ...
    def test_associations(self):
        ...
        self.add_associations(
            [hostgroup.PKEY3], facet="memberof_hostgroup", delete=True
        )
        ...
        # -------
        self.delete(
            hostgroup.ENTITY, [hostgroup.DATA, hostgroup.DATA2, hostgroup.DATA3]
        )
    ...
    def test_indirect_associations(self):
        ...
        self.assert_indirect_record(
            hostgroup.PKEY3, hostgroup.ENTITY, "member_hostgroup"
        )
        self.assert_indirect_record(host.pkey2, hostgroup.ENTITY, "member_host")

        self.assert_indirect_record(
            hostgroup.PKEY5, hostgroup.ENTITY, "memberof_hostgroup"
        )
        self.assert_indirect_record(
            hbac.RULE_PKEY, hostgroup.ENTITY, "memberof_hbacrule"
        )
        self.assert_indirect_record(
            sudo.RULE_PKEY, hostgroup.ENTITY, "memberof_sudorule"
        )
    ...
    def test_names_and_button(self):
        ...
        check_invalid_names(self, invalid_names, hostgroup.DUPLICATE_WARNING_MSG)
        ...
        assert hostgroup.DESCRIPTION_ERROR_DIALOG in self.get_last_error_dialog().text
        ...
        self.dialog_button_click("add")
        assert hostgroup.DUPLICATE_WARNING_MSG in self.get_last_error_dialog().text
        self.dialog_button_click("cancel")
        self.dialog_button_click("cancel")
