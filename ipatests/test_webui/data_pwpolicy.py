...
DATA = {
    "pkey": "admins",
    "add": [("combobox", "cn", "admins"), ("textbox", "cospriority", "364"),],
    "mod": [
...
DATA1 = {
    "pkey": group.PKEY,
    "add": [("combobox", "cn", group.PKEY), ("textbox", "cospriority", "1"),],
}

PKEY2 = group.PKEY2
DATA2 = {
    "pkey": group.PKEY2,
    "add": [("combobox", "cn", group.PKEY2), ("textbox", "cospriority", "2"),],
}

PKEY3 = group.PKEY3
DATA3 = {
    "pkey": group.PKEY3,
    "add": [("combobox", "cn", group.PKEY3), ("textbox", "cospriority", "3"),],
}

PKEY6 = group.PKEY6
DATA_RESET = {
    "pkey": group.PKEY6,
    "add": [("combobox", "cn", group.PKEY6), ("textbox", "cospriority", "6"),],
    "mod": [
...
DATA7 = {
    "pkey": group.PKEY4,
    "add": [("combobox", "cn", group.PKEY4), ("textbox", "cospriority", "4"),],
}
