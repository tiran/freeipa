...
class test_migratepw(XMLRPC_test, Unauthorized_HTTP_test):
    ...
    def _migratepw(self, user, password, method="POST"):
        ...
        return self.send_request(
            method, params={"username": str(user), "password": str(password)},
        )
    ...
    def test_bad_params(self):
        ...
        for params in (
            ...
            {"username": "", "password": ""},  # empty options
            {"username": "", "password": "bar"},  # empty username
            {"username": "foo", "password": ""},  # empty password
        ):
    ...
    def test_invalid_password(self):
        ...
        assert_equal(response.getheader("X-IPA-Migrate-Result"), "invalid-password")
