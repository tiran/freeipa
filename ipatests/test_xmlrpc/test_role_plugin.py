...
privilege1_dn = DN(("cn", privilege1), DN(api.env.container_privilege), api.env.basedn)
...
class test_role(Declarative):
    ...
    tests = [
        ...
        dict(
            ...
            expected=dict(
                count=0, truncated=False, summary=u"0 roles matched", result=[],
            ),
        ),
        dict(
            desc="Create invalid %r" % invalidrole1,
            command=("role_add", [invalidrole1], dict(description=u"role desc 1")),
            expected=errors.ValidationError(
                name="name", error=u"Leading and trailing spaces are not allowed"
            ),
        ),
        dict(
            desc="Create %r" % role1,
        ...
        dict(
            ...
            expected=dict(
                value=role1,
                summary=None,
                result=dict(dn=role1_dn, cn=[role1], description=[u"role desc 1"],),
            ),
        ),
        dict(
            ...
            command=(
                "group_add",
                [group1],
                dict(description=u"group desc 1", nonposix=True,),
            ),
            expected=dict(
                value=group1,
        ...
        dict(
            ...
            expected=dict(
                completed=1,
                failed=dict(member=dict(privilege=[],),),
                result={
                    "dn": role1_dn,
                    "cn": [role1],
                    "description": [u"role desc 1"],
        ...
        dict(
            ...
            expected=dict(
                completed=1,
                failed=dict(
                    member=dict(user=[], group=[], host=[], hostgroup=[], service=[],),
                ),
                result={
                    "dn": role1_dn,
                    "cn": [role1],
        ...
        dict(
            ...
            expected=dict(
                ...
                summary=u"1 role matched",
                result=[
                    {"dn": role1_dn, "cn": [role1], "description": [u"role desc 1"],},
                ],
            ),
        ),
        dict(
        ...
        dict(
            desc="Create %r" % role2,
            command=("role_add", [role2], dict(description=u"role desc 2")),
            expected=dict(
                value=role2,
        ...
        dict(
            ...
            expected=dict(
                ...
                result=[
                    ...
                    {"dn": role2_dn, "cn": [role2], "description": [u"role desc 2"],},
                ],
            ),
        ),
        dict(
        ...
        dict(
            desc="Update %r" % role1,
            command=("role_mod", [role1], dict(description=u"New desc 1")),
            expected=dict(
                value=role1,
        ...
        dict(
            ...
            command=("role_remove_privilege", [role1], dict(privilege=privilege1)),
            expected=dict(
                completed=1,
                failed=dict(member=dict(privilege=[],),),
                result={"dn": role1_dn, "cn": [role1], "description": [u"New desc 1"],},
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                failed=dict(
                    member=dict(
                        privilege=[
                            (u"%s" % privilege1, u"This entry is not a member"),
                        ],
                    ),
                ),
                result={"dn": role1_dn, "cn": [role1], "description": [u"New desc 1"],},
