...
dn1 = DN(
    ("cn", hbacsvcgroup1), ("cn", "hbacservicegroups"), ("cn", "hbac"), api.env.basedn
)

hbacsvc1 = u"sshd"
hbacsvc_dn1 = DN(
    ("cn", hbacsvc1), ("cn", "hbacservices"), ("cn", "hbac"), api.env.basedn
)
...
class test_hbacsvcgroup(Declarative):
    ...
    tests = [
        ...
        dict(
            ...
            command=("hbacsvc_add", [hbacsvc1], dict(description=u"Test service 1",),),
            expected=dict(
                value=hbacsvc1,
        ...
        dict(
            ...
            expected=dict(
                completed=1,
                failed=dict(member=dict(hbacsvc=tuple(),),),
                result={
                    "dn": dn1,
                    "cn": [hbacsvcgroup1],
                    "description": [u"Test hbacsvcgroup 1"],
        ...
        dict(
            ...
            command=("hbacsvcgroup_find", [], dict(cn=hbacsvcgroup1, no_members=False)),
            expected=dict(
                count=1,
                truncated=False,
