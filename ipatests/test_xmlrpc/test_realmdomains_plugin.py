    ...
    tests = [
        dict(
            ...
            expected=dict(
                value=None,
                summary=None,
                result=dict(dn=dn, associateddomain=[our_domain],),
            ),
        ),
        dict(
                ...
                messages=(
                    {
                        ...
                        u"data": {
                            ...
                            u"error": (u"%s.: DNS zone not found" % new_domain_1),
                        },
                    },
                ),
                result=dict(associateddomain=[our_domain, new_domain_1],),
            ),
        ),
        dict(
            ...
            expected=dict(
                value=None,
                summary=None,
                result=dict(associateddomain=[our_domain, new_domain_1, new_domain_2],),
                messages=(
                    {
                        u"message": u"The _kerberos TXT record from domain "
                        ...
                        "is not managed by IPA. Please create the record "
                        "manually, containing the following value: "
                        "'%(realm)s'" % dict(domain=new_domain_2, realm=api.env.realm),
                        u"code": 13011,
                        u"type": u"warning",
                        u"name": u"KerberosTXTRecordCreationFailure",
                        u"data": {
                            ...
                            u"realm": api.env.realm,
                            u"error": (u"%s.: DNS zone not found" % new_domain_2),
                        },
                    },
                ),
            ),
        ...
        dict(
            ...
            command=(
                "realmdomains_mod",
                [],
                {"add_domain": new_domain_2, "del_domain": new_domain_1, "force": True},
            ),
            expected=dict(
                value=None,
                summary=None,
                result=dict(associateddomain=[our_domain, new_domain_2],),
                messages=(
                    {
                        u"message": u"The _kerberos TXT record from domain "
                        "%(domain)s could not be created (%(domain)s.: "
        ...
        dict(
            ...
            expected=dict(
                value=None,
                summary=None,
                result=dict(associateddomain=[our_domain, new_domain_2, bad_domain],),
                messages=(
                    {
                        u"message": u"The _kerberos TXT record from domain "
                        "%(domain)s could not be created (%(domain)s.: "
                        ...
                        "is not managed by IPA. Please create the record "
                        "manually, containing the following value: "
                        "'%(realm)s'" % dict(domain=bad_domain, realm=api.env.realm),
                        u"code": 13011,
                        u"type": u"warning",
                        u"name": u"KerberosTXTRecordCreationFailure",
                        u"data": {
                            u"domain": bad_domain,
                            u"realm": api.env.realm,
                            u"error": (u"%s.: DNS zone not found" % bad_domain),
                        },
                    },
                ),
            ),
        ...
        dict(
            ...
            expected=errors.ValidationError(
                name="add_domain", error="single label domains are not supported"
            ),
        ),
    ]
