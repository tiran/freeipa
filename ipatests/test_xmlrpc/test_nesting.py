...
class TestNestingUserGroups(XMLRPC_test):
    def test_create_groups_and_users(
        self, group1, group2, group3, group4, user1, user2, user3, user4
    ):
    ...
    def test_add_user_members_to_groups(
        self, user1, user2, user3, user4, group1, group2, group3, group4
    ):
        ...
        group4.attrs.update(
            memberof_group=[group3.cn], memberofindirect_group=[group1.cn]
        )
        ...
        group3.attrs.update(memberindirect_user=[u"tuser4", u"tuser1"])
...
class TestNestingHostGroups(XMLRPC_test):
    ...
    def test_nest_hostgroups(self, host1, hostgroup1, hostgroup2):
        ...
        command = hostgroup1.make_add_member_command(dict(hostgroup=hostgroup2.cn))
