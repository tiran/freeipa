...
host_dn1 = DN(("fqdn", host1), ("cn", "computers"), ("cn", "accounts"), api.env.basedn)
...
class test_netgroup(Declarative):
    ...
    tests = [
        dict(
            ...
            expected=errors.NotFound(reason=u"%s: netgroup not found" % netgroup1),
        ),
        dict(
        ...
        dict(
            ...
            expected=errors.ValidationError(
                name="name", error=u"may only include letters, numbers, _, -, and ."
            ),
        ),
        dict(
            ...
            expected=errors.ValidationError(
                name="nisdomain", error="may only include letters, numbers, _, -, and ."
            ),
        ),
        dict(
        ...
        dict(
            ...
            command=("netgroup_add", [netgroup1], dict(description=u"Test netgroup 1")),
            expected=dict(
                value=netgroup1,
        ...
        dict(
            ...
            command=("netgroup_add", [netgroup2], dict(description=u"Test netgroup 2")),
            expected=dict(
                value=netgroup2,
        ...
        dict(
            desc="Create %r" % user2,
            command=("user_add", [user2], dict(givenname=u"Test", sn=u"User2")),
            expected=dict(
                value=user2,
        ...
        dict(
            ...
            command=("netgroup_add_member", [netgroup1], dict(hostgroup=hostgroup1)),
            expected=dict(
                completed=1,
                failed=dict(
                    member=dict(netgroup=tuple(),),
        ...
        dict(
            ...
            command=("netgroup_find", [], dict(no_user=user1, no_members=False)),
            expected=dict(
                count=2,
                truncated=False,
        ...
        dict(
            ...
            expected=dict(
                count=0, truncated=False, summary=u"0 netgroups matched", result=[],
            ),
        ),
        dict(
        ...
        dict(
            ...
            command=("netgroup_add_member", [netgroup1], dict(netgroup=netgroup2)),
            expected=dict(
                completed=1,
                failed=dict(
                    member=dict(netgroup=tuple(),),
        ...
        dict(
            ...
            command=("netgroup_add_member", [netgroup1], dict(netgroup=u"notfound")),
            expected=dict(
                completed=0,
                failed=dict(
        ...
        dict(
            ...
            expected=dict(
                ...
                failed=dict(
                    ...
                    memberhost=dict(
                        hostgroup=[
                            ("%s" % hostgroup1, u"This entry is already a member")
                        ],
                        host=tuple(),
                    ),
                ),
        ...
        dict(
            ...
            command=("netgroup_add_member", [netgroup1], dict(host=unknown_host)),
            expected=dict(
                completed=1,
                failed=dict(
                    member=dict(netgroup=tuple(),),
        ...
        dict(
            desc=("Search for all netgroups using empty member user with " "members"),
        ...
        dict(
            ...
            command=("netgroup_remove_member", [netgroup1], dict(hostgroup=hostgroup1)),
            expected=dict(
                completed=1,
                failed=dict(
                    member=dict(netgroup=tuple(),),
        ...
        dict(
            ...
            command=("netgroup_remove_member", [netgroup1], dict(netgroup=netgroup2)),
            expected=dict(
                completed=1,
                failed=dict(
                    member=dict(netgroup=tuple(),),
