    ...
    tests = (
        [
            ...
            dict(
                ...
                expected=errors.DuplicateEntry(
                    message=_("RADIUS proxy server " 'with name "%s" already exists')
                    % radius1
                ),
            ),
            dict(
        ...
        + [
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(ipatokenradiustimeout=num)),
                expected=dict(
                    value=radius1,
        ...
        + [
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(ipatokenradiustimeout=0)),
            ...
            dict(
                ...
                expected=dict(
                    value=radius1,
                    summary=u'Modified RADIUS proxy server "%s"' % radius1,
                    result=dict(cn=[radius1], ipatokenradiusserver=[radius1_fqdn],),
                ),
            ),
        ]
        + [
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(ipatokenradiusretries=num)),
                expected=dict(
                    value=radius1,
                    summary=u'Modified RADIUS proxy server "%s"' % radius1,
                    result=dict(
        ...
        + [
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(ipatokenradiusretries=num)),
                expected=errors.ValidationError(name="retries", error=reason),
            )
            for num, reason in (
        ...
        + [
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(ipatokenradiusserver=fqdn)),
                expected=dict(
                    value=radius1,
                    summary=u'Modified RADIUS proxy server "%s"' % radius1,
                    result=dict(cn=[radius1], ipatokenradiusserver=[fqdn],),
                ),
            )
        ...
        + [
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(ipatokenradiusserver=fqdn)),
                expected=errors.ValidationError(
                    name="ipatokenradiusserver", error=error
                ),
            )
            for fqdn, error in (
        ...
        + [
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(ipatokenradiusserver=None)),
            ...
            dict(
                ...
                expected=errors.ValidationError(
                    name="ipatokenusermapattribute", error=u"invalid attribute name"
                ),
            ),
            dict(
            ...
            dict(
                ...
                command=("radiusproxy_mod", [radius1], dict(description=None)),
                expected=dict(
                    value=radius1,
                    summary=u'Modified RADIUS proxy server "%s"' % radius1,
                    result=dict(cn=[radius1], ipatokenradiusserver=[radius1_fqdn],),
            ...
            dict(
                ...
                command=("user_mod", [user1], dict(ipatokenradiusconfiglink=radius1,)),
                expected=dict(
