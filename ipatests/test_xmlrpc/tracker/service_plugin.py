...
class ServiceTracker(KerberosAliasMixin, Tracker):
    ...
    retrieve_keys = {
        ...
        u"valid_not_after",
        u"sha1_fingerprint",
        u"sha256_fingerprint",
        u"krbprincipalauthind",
        u"managedby_host",
        u"krbcanonicalname",
    }
    retrieve_all_keys = retrieve_keys | {
        u"ipaKrbPrincipalAlias",
        u"ipaUniqueID",
        u"krbExtraData",
        u"krbLastPwdChange",
        u"krbLoginFailedCount",
        u"memberof",
        u"objectClass",
    ...
    def __init__(self, name, host_fqdn, options=None):
        ...
        self.dn = DN(
            ("krbprincipalname", self.name), api.env.container_service, api.env.basedn
        )
    ...
    def make_create_command(self, force=True):
        ...
        return self.make_command("service_add", self.name, force=force, **self.options)
