...
class IdviewTracker(Tracker):
    ...
    retrieve_all_keys = retrieve_keys | {u"description", u"objectclass", u"dn"}
    ...
    def make_create_command(self):
        return self.make_command("idview_add", self.cn, **self.kwargs)

    def make_delete_command(self):
        return self.make_command("idview_del", self.cn, **self.kwargs)
    ...
    def make_add_idoverrideuser_command(self, username, options=None):
        ...
        return self.make_command("idoverrideuser_add", self.cn, username, **options)
    ...
    def check_idoverrideuser_add(self, result, user):
        ...
        assert_deepequal(u'Added User ID override "%s"' % user.name, result["summary"])
