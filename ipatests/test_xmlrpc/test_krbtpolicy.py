...
def create_dict(desc, param, param_name, value, error):
    ...
    if value != u"abc123":
        return dict(
            desc=desc,
            command=("krbtpolicy_mod", [user1], cmd_args),
            expected=errors.ValidationError(name=param_name, error=error),
        )
    else:
        return dict(
            desc=desc,
            command=("krbtpolicy_mod", [user1], cmd_args),
            expected=errors.ConversionError(name=param_name, error=error),
        )
...
class test_krbtpolicy(Declarative):
    ...
    tests = [
        dict(
            ...
            expected=dict(
                ...
                summary=None,
                result=dict(
                    krbmaxticketlife=[u"86400"], krbmaxrenewableage=[u"604800"],
                ),
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                summary=None,
                result=dict(
                    dn=DN(("cn", api.env.domain), ("cn", "kerberos"), api.env.basedn),
        ...
        dict(
            ...
            expected=dict(
                ...
                summary=None,
                result=dict(
                    krbmaxticketlife=[u"3600"], krbmaxrenewableage=[u"604800"],
                ),
            ),
        ),
        dict(
        ...
        dict(
            ...
            expected=dict(
                value=user1, summary=None, result=dict(krbmaxticketlife=[u"3600"],),
            ),
        ),
        dict(
        ...
        dict(
            ...
            command=("krbtpolicy_mod", [user1], dict(krbauthindmaxticketlife_otp=3700)),
            expected=dict(
                value=user1,
                summary=None,
                result=dict(
        ...
        dict(
            ...
            command=("krbtpolicy_mod", [user1], dict(krbauthindmaxticketlife_radius=1)),
            expected=dict(
                value=user1,
                summary=None,
                result=dict(
        ...
        dict(
            desc="Update maxrenew user ticket policy for " "auth indicator hardened",
            command=(
                "krbtpolicy_mod",
                [user1],
        ...
        dict(
            desc="Update maxrenew user ticket policy for " "auth indicator otp",
            command=(
                "krbtpolicy_mod",
                [user1],
        ...
        dict(
            desc="Update maxrenew user ticket policy for " "auth indicator radius",
            command=(
                "krbtpolicy_mod",
                [user1],
        ...
        dict(
            desc="Update maxrenew user ticket policy for " "auth indicator pkinit",
            command=(
                "krbtpolicy_mod",
                [user1],
        ...
        dict(
            ...
            command=("krbtpolicy_mod", [user1], dict(setattr=u"givenname=Pete")),
    ...
    for (value, error) in invalid_values:
        for (param, param_name) in parameters:
            tests.append(
                create_dict(
                    desc="Try updating invalid {0} with {1}".format(param_name, value),
                    param=param,
