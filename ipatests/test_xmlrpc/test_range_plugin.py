...
trust_local_dn = "cn={domain},{smbcont}".format(
    domain=api.env.domain, smbcont=smb_cont_dn
)
    ...
    tests = [
        ...
        dict(
            ...
            command=(
                "user_add",
                [user1],
                dict(givenname=u"Test", sn=u"User1", uidnumber=user1_uid),
            ),
            expected=dict(
                value=user1,
        ...
        dict(
            ...
            command=("idrange_mod", [testrange1], dict(ipabaseid=user1_uid + 1)),
        ...
        dict(
            ...
            expected=errors.DependentEntry(
                label="Active Trust domain", key=domain2range1, dependent=domain2
            ),
        ),
        ...
        dict(
            desc=(
                ...
                " range with nonposix range from different domain" % (domain2range1)
            ),
            command=(
                "idrange_mod",
                [domain2range1],
        ...
        dict(
            ...
            expected=dict(
                result=dict(
                    ...
                    ipasecondarybaserid=[unicode(testrange9_secondary_base_rid)],
