...
class test_servicedelegation(Declarative):
    ...
    tests = [
        ...
        dict(
            desc="Create %r" % rule1,
            command=("servicedelegationrule_add", [rule1], {}),
            expected=dict(
                value=rule1,
        ...
        dict(
            ...
            expected=dict(
                value=rule1,
                summary=None,
                result=dict(cn=[rule1], dn=get_servicedelegation_dn(rule1),),
            ),
        ),
        dict(
            ...
            expected=dict(
                count=1,
                truncated=False,
                result=[dict(dn=get_servicedelegation_dn(rule1), cn=[rule1],),],
        ...
        dict(
            desc="Create %r" % rule2,
            command=("servicedelegationrule_add", [rule2], {}),
            expected=dict(
                value=rule2,
        ...
        dict(
            ...
            expected=dict(
                ...
                result=[
                    ...
                    dict(dn=get_servicedelegation_dn(rule2), cn=[rule2],),
                    dict(dn=get_servicedelegation_dn(rule1), cn=[rule1],),
                ],
            ),
        ),
        dict(
        ...
        dict(
            ...
            command=("servicedelegationtarget_add", [target1], {}),
            expected=dict(
                value=target1,
        ...
        dict(
            ...
            command=("servicedelegationtarget_add", [target2], {}),
            expected=dict(
                value=target2,
        ...
        dict(
            ...
            expected=dict(
                ...
                result=[
                    {
                        "dn": get_servicedelegation_dn(u"ipa-cifs-delegation-targets"),
                        "cn": [u"ipa-cifs-delegation-targets"],
                    },
                    {
                        "dn": get_servicedelegation_dn(u"ipa-ldap-delegation-targets"),
                        "cn": [u"ipa-ldap-delegation-targets"],
                        "memberprincipal": [princ2],
                    },
                    dict(dn=get_servicedelegation_dn(target1), cn=[target1],),
                    dict(dn=get_servicedelegation_dn(target2), cn=[target2],),
                ],
            ),
        ),
        ###############
        ...
        dict(
            ...
            expected=dict(
                completed=1,
                failed=dict(ipaallowedtarget=dict(servicedelegationtarget=tuple(),),),
                result={
                    "dn": get_servicedelegation_dn(rule1),
        ...
        dict(
            ...
            expected=dict(
                ...
                failed=dict(
                    ipaallowedtarget=dict(
                        servicedelegationtarget=[[u"notfound", u"no such entry"]],
                    ),
                ),
                result={
                    "dn": get_servicedelegation_dn(rule1),
        ...
        dict(
            ...
            expected=dict(
                completed=1,
                failed=dict(ipaallowedtarget=dict(servicedelegationtarget=tuple(),),),
                result={"dn": get_servicedelegation_dn(rule1), "cn": [rule1],},
            ),
        ),
        dict(
            desc="Remove non-existent target %r from %r" % (u"notfound", rule1),
            command=(
                "servicedelegationrule_remove_target",
                [rule1],
                dict(servicedelegationtarget=u"notfound"),
        ...
        dict(
            ...
            expected=dict(
                completed=1,
                failed=dict(failed_memberprincipal=dict(memberprincipal=tuple(),),),
                result={
                    "dn": get_servicedelegation_dn(rule1),
                    "memberprincipal": (princ1,),
                    "cn": [rule1],
            ...
            expected=dict(
                ...
                failed=dict(
                    failed_memberprincipal=dict(
                        memberprincipal=[[princ1, u"This entry is already a member"]],
                    ),
                ),
                result={
                    "dn": get_servicedelegation_dn(rule1),
        ...
        dict(
            ...
            expected=dict(
                ...
                failed=dict(
                    failed_memberprincipal=dict(
                        memberprincipal=[
                            [u"HTTP/notfound@%s" % api.env.realm, u"no such entry"]
                        ],
                    ),
                ),
                result={
        ...
        dict(
            desc="Add non-existent member %r to %r" % (u"HTTP/notfound", target1),
            command=(
                "servicedelegationtarget_add_member",
                [target1],
                dict(principal=u"HTTP/notfound@%s" % api.env.realm),
        ...
        dict(
            desc="Remove non-existent member %r from %r" % (u"HTTP/notfound", target1),
            command=(
                "servicedelegationtarget_remove_member",
                [target1],
                dict(principal=u"HTTP/notfound@%s" % api.env.realm),
            ...
            expected=dict(
                ...
                result={"dn": get_servicedelegation_dn(target1), "cn": [target1],},
            ),
        ),
    ]
