...
class AutomountTest(XMLRPC_test):
    ...
    def check_import_roundtrip(self):
        ...
        assert current_file is not None, (
            "The input file does not contain any" "records of files to be opened."
        )
        current_file.close()
        ...
        try:
            ...
            res = automountlocation_import(self.locname, master_file, version=u"2.88")
            assert_deepequal(
                dict(
                    result=dict(
                        keys=lambda k: k,
...
class test_automount(AutomountTest):
    ...
    def test_2_automountkey_add(self):
        ...
        res = api.Command["automountkey_add"](
            self.locname, self.mapname, **self.key_kw2
        )["result"]
        assert res
    ...
    def test_5_automountmap_show(self):
        ...
        """
        res = api.Command["automountmap_show"](self.locname, self.mapname, raw=True)[
            "result"
        ]
        assert res
        assert_attr_equal(res, "automountmapname", self.mapname)
    ...
    def test_6_automountmap_find(self):
        ...
        """
        res = api.Command["automountmap_find"](self.locname, self.mapname, raw=True)[
            "result"
        ]
    ...
    def test_7_automountkey_show(self):
        ...
        showkey_kw = {
            ...
            "automountinformation": self.info,
            "raw": True,
        }
        res = api.Command["automountkey_show"](
            self.locname, self.mapname, **showkey_kw
        )["result"]
        assert res
        assert_attr_equal(res, "automountkey", self.keyname)
    ...
    def test_8_automountkey_find(self):
        ...
        """
        res = api.Command["automountkey_find"](self.locname, self.mapname, raw=True)[
            "result"
        ]
        assert res
        assert len(res) == 2
    ...
    def test_9_automountkey_mod(self):
        ...
        res = api.Command["automountkey_mod"](
            self.locname, self.mapname, **self.key_kw
        )["result"]
        assert res
    ...
    def test_a1_automountmap_mod(self):
        ...
        res = api.Command["automountmap_mod"](self.locname, self.mapname, **mod_kw)[
            "result"
        ]
        assert res
    ...
    def test_a2_automountmap_tofiles(self):
        ...
        """
        res = api.Command["automountlocation_tofiles"](self.locname, version=u"2.88")
        assert_deepequal(
            dict(
                result=dict(
                    keys={"auto.direct": ()},
    ...
    def test_b_automountkey_del(self):
        ...
        delkey_kw = {
            "automountkey": self.keyname_rename,
            "automountinformation": self.newinfo,
        }
        res = api.Command["automountkey_del"](self.locname, self.mapname, **delkey_kw)[
            "result"
        ]
        assert res
        assert not res["failed"]
...
class test_automount_indirect(AutomountTest):
    ...
    def test_3_automountkey_del(self):
        ...
        res = api.Command["automountkey_del"](
            self.locname, self.parentmap, **self.key_kw
        )["result"]
        assert res
        assert not res["failed"]
...
class test_automount_indirect_no_parent(AutomountTest):
    ...
    def test_2_automountkey_show(self):
        ...
        showkey_kw = {
            "automountkey": self.keyname,
            "automountinformation": self.mapname,
            "raw": True,
        }
        res = api.Command["automountkey_show"](
            self.locname, self.parentmap, **showkey_kw
        )["result"]
        assert res
        assert_attr_equal(res, "automountkey", self.keyname)
    ...
    def test_3_automountkey_del(self):
        ...
        res = api.Command["automountkey_del"](
            self.locname, self.parentmap, **delkey_kw
        )["result"]
        assert res
        assert not res["failed"]
