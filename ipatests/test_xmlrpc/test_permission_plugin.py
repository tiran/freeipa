...
permission1_dn = DN(("cn", permission1), api.env.container_permission, api.env.basedn)


permission1_renamed = u"testperm1_rn"
permission1_renamed_dn = DN(
    ("cn", permission1_renamed), api.env.container_permission, api.env.basedn
)

permission1_renamed_ucase = u"Testperm_RN"
permission1_renamed_ucase_dn = DN(
    ("cn", permission1_renamed_ucase), api.env.container_permission, api.env.basedn
)


permission2 = u"testperm2"
permission2_dn = DN(("cn", permission2), api.env.container_permission, api.env.basedn)

permission3 = u"testperm3"
permission3_dn = DN(("cn", permission3), api.env.container_permission, api.env.basedn)
...
privilege1_dn = DN(("cn", privilege1), api.env.container_privilege, api.env.basedn)
...
def verify_permission_aci(name, dn, acistring):
    ...
    return dict(
        ...
        command=(
            "aci_show",
            [name],
            dict(aciprefix=u"permission", location=dn, raw=True),
        ),
        expected=dict(result=dict(aci=acistring), summary=None, value=name,),
    )
...
def verify_permission_aci_missing(name, dn):
    ...
    return dict(
        ...
        expected=errors.NotFound(reason='ACI with name "%s" not found' % name),
    )
...
class test_permission_negative(Declarative):
    ...
    tests = [
        dict(
            ...
            expected=errors.NotFound(reason=u"%s: permission not found" % permission1),
        ),
        dict(
        ...
        dict(
            ...
            expected=dict(
                count=0, truncated=False, summary=u"0 permissions matched", result=[],
            ),
        ),
        dict(
        ...
        dict(
            ...
            command=(
                "permission_add",
                [invalid_permission1],
                dict(type=u"user", ipapermright=u"write",),
            ),
            expected=errors.ValidationError(
                name="name",
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(type=u"user", ipapermright=u"write", attrs=u"bogusattr",),
            ),
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(type=u"user", ipapermright=[u"write"], attrs=[u"sn"],),
            ),
            expected=dict(
                value=permission1,
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(ipapermright=None,)),
            expected=errors.RequirementError(name="right"),
        ),
        dict(
            desc="Try to remove type from %r" % permission1,
            command=("permission_mod", [permission1], dict(attrs=None, type=None,)),
            expected=errors.ValidationError(
                name="target",
                error="there must be at least one target entry specifier "
                "(e.g. target, targetfilter, attrs)",
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(memberof=None,)),
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(attrs=None, ipapermtargetfilter=None,),
            ),
            expected=errors.ValidationError(
                name="target",
                error="there must be at least one target entry specifier "
        ...
        dict(
            desc="Try to rename %r to invalid %r" % (permission1, invalid_permission1),
            command=(
                "permission_mod",
                [permission1],
                dict(rename=invalid_permission1,),
            ),
            expected=errors.ValidationError(
                name="rename",
                error="May only contain letters, numbers, -, _, ., and space",
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(ipapermtargetfilter=u"(cn=*)", extratargetfilter=u"(sn=*)",),
            ),
            expected=errors.ValidationError(
                name="ipapermtargetfilter",
                error="cannot specify full target filter and extra target "
...
class test_permission(Declarative):
    ...
    tests = [
        ...
        dict(
            ...
            command=("permission_find", [], {"cn": permission1, "no_members": False}),
            expected=dict(
                count=1,
                truncated=False,
                summary=u"1 permission matched",
        ...
        dict(
            ...
            expected=dict(
                ...
                summary=u"2 permissions matched",
                result=[
                    {"dn": permission1_dn, "cn": [permission1],},
                    {"dn": permission2_dn, "cn": [permission2],},
                ],
            ),
        ),
        dict(
            ...
            command=(
                "permission_find",
                [],
                {"pkey_only": True, "attrs": [u"krbminpwdlife"]},
            ),
            expected=dict(
                count=2,
                truncated=False,
        ...
        dict(
            desc=(
                "Search for %r with a limit of 1 (truncated) with members" % permission1
            ),
            command=(
                "permission_find",
                [permission1],
            ...
            expected=dict(
                ...
                messages=(
                    {
                        "message": (
                            u"Search result has been truncated: "
                            u"Configured size limit exceeded"
                        ),
                        "code": 13017,
                        "type": u"warning",
                        "name": u"SearchResultTruncated",
                        "data": {"reason": u"Configured size limit exceeded"},
                    },
                ),
            ),
        ),
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(rename=permission2, ipapermright=u"all",),
            ),
            expected=errors.DuplicateEntry(),
        ),
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(rename=u"", ipapermright=u"all",),
            ),
            expected=errors.ValidationError(
                name="rename", error=u"New name can not be empty"
            ),
        ),
        dict(
        ...
        dict(
            desc="Rename %r to permission %r" % (permission1, permission1_renamed),
            command=(
                "permission_mod",
                [permission1],
                dict(rename=permission1_renamed, ipapermright=u"all",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1_renamed],
                dict(rename=permission1_renamed_ucase, ipapermright=u"write",),
            ),
            expected=dict(
        ...
        verify_permission_aci(
            ...
            + 'allow (write) groupdn = "ldap:///%s";)' % permission1_renamed_ucase_dn,
        ),
        dict(
        ...
        dict(
            desc=(
                "Search for %r using --subtree with membes" % permission1_renamed_ucase
            ),
            command=(
                "permission_find",
                [],
                {"ipapermlocation": u"ldap:///%s" % admin_dn, "no_members": False},
            ),
            expected=dict(
                count=1,
                truncated=False,
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(memberof=u"nonexisting", ipapermright=u"write", attrs=[u"cn"],),
            ),
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(memberof=u"admins",)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(targetgroup=u"editors", ipapermright=u"write", attrs=[u"sn"],),
            ),
            expected=dict(
                value=permission1,
                summary=u'Added permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission3],
                dict(type=u"user", ipapermright=u"write", attrs=[u"cn"]),
            ),
            expected=dict(
                value=permission3,
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission3],
                {"all": True, "rights": True, "attrs": [u"cn", u"uid"]},
            ),
            expected=dict(
                value=permission3,
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(ipapermlocation=nonexistent_dn,),
            ),
            expected=errors.ValidationError(
                name="ipapermlocation", error="Entry %s does not exist" % nonexistent_dn
            ),
        ),
        dict(
    ...
    tests = (
        ...
        + [
            dict(
                ...
                command=(
                    "permission_mod",
                    [permission1],
                    dict(ipapermlocation=DN("foo=bar"),),
                ),
                expected=errors.ValidationError(
                    name="ipapermlocation", error="Entry foo=bar does not exist"
                ),
            ),
        ]
        + _verifications
        + [
            dict(
                ...
                command=("permission_mod", [permission1], dict(ipapermlocation=etc_dn)),
                expected=errors.InvalidSyntax(
                    ...
                    r"allow (write) groupdn = \22ldap:///%(pdn)s\22;)"
                    % dict(
                        sdn=etc_dn, tdn=DN("uid=admin", users_dn), pdn=permission1_dn
                    )
                ),
            ),
        ]
        ...
        + [
            dict(
                desc="Try adding an invalid attribute on %r with --all --rights"
                % permission1,
                command=(
                    "permission_mod",
                    [permission1],
                    dict(attrs=[u"cn", u"bogusattributexyz"], rights=True, all=True,),
                ),
                expected=errors.InvalidSyntax(
...
class test_permission_sync_attributes(Declarative):
    ...
    tests = [
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(ipapermlocation=None,)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(ipapermlocation=users_dn,)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=(
                ...
                [permission1],
                dict(
                    ipapermtargetfilter=u"(memberOf=%s)"
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(ipapermtargetfilter=None,)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(type=u"group",)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(ipapermtarget=DN("cn=editors", groups_dn),),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(extratargetfilter=u"(cn=blabla)",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(type=u"user", ipapermtarget=None,),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
...
class test_permission_sync_nice(Declarative):
    ...
    tests = [
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(type=None,)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(targetgroup=u"editors",)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
    ...
    tests = (
        [
            ...
            dict(
                ...
                command=("permission_show", [permission1], dict(all=True, raw=True)),
                expected=dict(
                    value=permission1,
                    summary=None,
                    result=dict(
            ...
            dict(
                ...
                command=(
                    "permission_mod",
                    [permission1],
                    dict(extratargetfilter=[u"(cn=*)", u"(l=*)"], all=True,),
                ),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "%s"' % permission1,
            ...
            dict(
                ...
                command=(
                    "permission_mod",
                    [permission1],
                    dict(ipapermtargetfilter=None, all=True,),
                ),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "%s"' % permission1,
        ...
        + [
            ...
            for option_name in ("extratargetfilter", "ipapermtargetfilter",)
        ...
        + [
            dict(
                ...
                command=(
                    ...
                    [permission1],
                    dict(
                        extratargetfilter=[u"(cn=*)", u"(objectclass=top)"], all=True,
                    ),
                ),
                expected=dict(
                    value=permission1,
            ...
            dict(
                ...
                % permission1,
                command=("permission_mod", [permission1], dict(type=None, all=True,)),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "%s"' % permission1,
                    result=dict(
            ...
            dict(
                ...
                command=(
                    "permission_mod",
                    [permission1],
                    dict(extratargetfilter=u"(memberof=*)", all=True,),
                ),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "%s"' % permission1,
            ...
            dict(
                ...
                % permission1,
                command=("permission_mod", [permission1], dict(memberof=[], all=True,)),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "%s"' % permission1,
                    result=dict(
...
class test_permission_flags(Declarative):
    ...
    tests = [
        ...
        _make_permission_flag_tests(
            [u"SYSTEM"], "A SYSTEM permission may not be modified or removed"
        )
        + _make_permission_flag_tests(
            [u"??"], "Permission with unknown flag ?? may not be modified or removed"
        )
        + _make_permission_flag_tests(
            [u"SYSTEM", u"??"],
...
def check_legacy_results(results):
    ...
    legacy_permissions = [p for p in results if not p.get("ipapermissiontype")]
...
class test_permission_legacy(Declarative):
    ...
    tests = [
        dict(
            ...
            command=("permission_find", [], {"ipapermlocation": api.env.basedn}),
            expected=dict(
    ...
    tests = [
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(type=u"user", ipapermbindruletype=u"all",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
        ...
        dict(
            ...
            command=("permission_find", [permission1], {"ipapermbindruletype": u"all"}),
            expected=dict(
                count=1,
                truncated=False,
                summary=u"1 permission matched",
        ...
        dict(
            desc="Rename %r to permission %r" % (permission1, permission1_renamed),
            command=("permission_mod", [permission1], dict(rename=permission1_renamed)),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1_renamed],
                dict(type=u"user", ipapermbindruletype=u"permission",),
            ),
            expected=dict(
                value=permission1_renamed,
                summary=u'Modified permission "%s"' % permission1_renamed,
        ...
        dict(
            ...
            command=("permission_mod", [permission1_renamed], dict(rename=permission1)),
            expected=dict(
                value=permission1_renamed,
                summary=u'Modified permission "%s"' % permission1_renamed,
                result=dict(
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(type=u"user", ipapermbindruletype=u"anonymous",),
            ),
            expected=errors.ValidationError(
    ...
    tests = (
        ...
        + [
            ...
            dict(
                ...
                command=("permission_mod", [permission1], {attr_name: value}),
                expected=errors.ValidationError(
        ...
        + [
            dict(
                ...
                command=("permission_mod", [permission1], {"rename": permission2}),
                expected=errors.ValidationError(
                    name="rename", error="cannot rename managed permissions"
                ),
            ),
            verify_permission_aci(
                permission1,
            ...
            dict(
                ...
                command=(
                    "permission_mod",
                    [permission1],
                    {"ipapermincludedattr": [u"cn", u"sn"], "all": True},
                ),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "testperm"',
            ...
            dict(
                ...
                command=(
                    "permission_mod",
                    [permission1],
                    {"ipapermincludedattr": [u"cn", u"sn", u"o"], "all": True},
                ),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "testperm"',
            ...
            dict(
                ...
                command=(
                    "permission_mod",
                    [permission1],
                    {"ipapermexcludedattr": [u"cn", u"sn"], "all": True},
                ),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "testperm"',
            ...
            dict(
                ...
                command=("permission_mod", [permission1], {"attrs": [u"l", u"o"]}),
                expected=dict(
                    value=permission1,
                    summary=u'Modified permission "testperm"',
                    result=dict(
            ...
            dict(
                desc="Try to delete %r" % permission1,
                command=("permission_del", [permission1], {}),
                expected=errors.ACIError(info="cannot delete managed permissions"),
            ),
            dict(
                desc="Delete %r with --force" % permission1,
                command=("permission_del", [permission1], {"force": True}),
    ...
    tests = [
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    ipapermissiontype=[u"SYSTEM", u"V2"],
                    ipapermlocation=[users_dn],
                    extratargetfilter=[u"(objectclass=top)",],
                ),
            ),
        ),
        verify_permission_aci(
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    ipapermissiontype=[u"SYSTEM", u"V2"],
                    ipapermlocation=[api.env.basedn],
                    extratargetfilter=[u"(objectclass=ipauser)",],
                ),
            ),
        ),
        verify_permission_aci(
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(memberof=None, addattr=u"ipapermtargetfilter=(cn=xyz)",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
                    ...
                    ipapermissiontype=[u"SYSTEM", u"V2"],
                    ipapermlocation=[api.env.basedn],
                    extratargetfilter=[u"(cn=xyz)", u"(objectclass=ipauser)",],
                ),
            ),
        ),
        verify_permission_aci(
        ...
        dict(
            ...
            command=(
                ...
                [permission1],
                dict(
                    type=u"user", memberof=u"admins", ipapermtargetfilter=u"(uid=abc)",
                ),
            ),
            expected=dict(
                value=permission1,
        ...
        dict(
            ...
            command=("permission_mod", [permission1], dict(type=None, memberof=None,),),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
                result=dict(
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(memberof=[u"admins", u"editors"],),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(type=u"user", ipapermright=u"write", ipapermtargetfilter=u"",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Added permission "%s"' % permission1,
