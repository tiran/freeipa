...
class test_hbactest(XMLRPC_test):
    ...
    def test_0_hbactest_addrules(self):
        ...
        self.failsafe_add(api.Object.host, self.test_sourcehost, force=True)
        self.failsafe_add(
            api.Object.hostgroup, self.test_sourcehostgroup, description=u"desc"
        )
        self.failsafe_add(api.Object.hbacsvc, self.test_service, description=u"desc")
    ...
    def test_g_hbactest_clear_testing_data(self):
        ...
        for i in [0, 1, 2, 3]:
            ...
            api.Command["hbacrule_remove_host"](
                self.rule_names[i], hostgroup=self.test_hostgroup
            )
