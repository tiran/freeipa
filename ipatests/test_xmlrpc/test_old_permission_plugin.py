    ...
    tests = [
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(type=u"user", permissions=u"write",),
            ),
            expected=dict(
                value=permission1,
                ...
                result=[
                    {
                        ...
                        "member": [privilege1_dn],
                        "aci": [
                            u'(targetfilter = "(objectclass=posixaccount)")(version 3.0;acl "permission:testperm";allow (write) groupdn = "ldap:///%s";)'
                            % DN(
                                ("cn", "testperm"),
                                ("cn", "permissions"),
                                ("cn", "pbac"),
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(rename=permission2, permissions=u"all",),
            ),
            expected=errors.DuplicateEntry(),
        ),
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(rename=u"", permissions=u"all",),
            ),
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1],
                dict(rename=permission1_renamed, permissions=u"all",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Modified permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_mod",
                [permission1_renamed],
                dict(rename=permission1_renamed_ucase, permissions=u"write",),
            ),
            expected=dict(
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(memberof=u"nonexisting", permissions=u"write",),
            ),
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(memberof=u"editors", permissions=u"write", type=u"user",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Added permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission1],
                dict(targetgroup=u"editors", permissions=u"write",),
            ),
            expected=dict(
                value=permission1,
                summary=u'Added permission "%s"' % permission1,
        ...
        dict(
            ...
            command=(
                "permission_add",
                [permission3],
                dict(type=u"user", permissions=u"write", attrs=[u"cn"]),
            ),
            expected=dict(
                value=permission3,
