...
trustconfig_ad_config = DN(
    ("cn", api.env.domain), api.env.container_cifsdomains, api.env.basedn
)
...
class test_trustconfig(Declarative):
    ...
    cleanup_commands = [
        ...
        (
            "trustconfig_mod",
            [],
            {"trust_type": u"ad", "ipantfallbackprimarygroup": default_group},
        ),
    ]
    ...
    tests = [
        ...
        dict(
            ...
            command=("group_add", [testgroup], dict(description=u"Test group")),
            expected=dict(
                value=testgroup,
        ...
        dict(
            ...
            expected=errors.NotFound(
                reason=u"%s: group not found" % "cn=doesnotexist,dc=test"
            ),
        ),
        dict(
            ...
            command=(
                "trustconfig_mod",
                [],
                {"trust_type": u"ad", "ipantfallbackprimarygroup": testgroup},
            ),
            expected={
                "value": u"ad",
