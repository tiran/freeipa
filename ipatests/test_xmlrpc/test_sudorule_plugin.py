...
class test_sudorule(XMLRPC_test):
    ...
    def test_0_sudorule_add(self):
        ...
        ret = self.failsafe_add(
            api.Object.sudorule, self.rule_name, description=self.rule_desc,
        )
        entry = ret["result"]
    ...
    def test_6_sudorule_find(self):
        ...
        ret = api.Command["sudorule_find"](
            cn=self.rule_name, description=self.rule_desc_mod
        )
    ...
    def test_7_sudorule_init_testing_data(self):
        ...
        self.failsafe_add(api.Object.group, self.test_group, description=u"description")
        self.failsafe_add(api.Object.host, self.test_host, force=True)
        self.failsafe_add(
            api.Object.hostgroup, self.test_hostgroup, description=u"description"
        )
        self.failsafe_add(
            api.Object.sudocmdgroup, self.test_sudoallowcmdgroup, description=u"desc"
        )
        self.failsafe_add(
            api.Object.sudocmdgroup, self.test_sudodenycmdgroup, description=u"desc"
        )
        self.failsafe_add(api.Object.sudocmd, self.test_command, description=u"desc")
    ...
    def test_a_sudorule_mod_externalhost_invalid_addattr(self):
        ...
        try:
            api.Command["sudorule_mod"](
                self.rule_name, addattr="externalhost=%s" % self.test_invalid_host
            )
    ...
    def test_a_sudorule_add_allow_command(self):
        ...
        assert_attr_equal(
            entry, "memberallowcmd_sudocmdgroup", self.test_sudoallowcmdgroup
        )
    ...
    def test_b_sudorule_add_deny_command(self):
        ...
        assert_attr_equal(
            entry, "memberdenycmd_sudocmdgroup", self.test_sudodenycmdgroup
        )
    ...
    def test_h_sudorule_exclusivecommand(self):
        ...
        try:
            ...
            api.Command["sudorule_remove_allow_command"](
                self.rule_name, sudocmd=self.test_command
            )
    ...
    def test_j_1_sudorule_exclusiverunas(self):
        ...
        try:
            ...
            api.Command["sudorule_remove_runasuser"](
                self.rule_name, user=self.test_command
            )
    ...
    def test_j_2_sudorule_referential_integrity(self):
        ...
        api.Command["sudorule_add_runasuser"](
            self.rule_name, user=self.test_runasuser, group=self.test_group
        )
        ...
        api.Command["sudorule_add_deny_command"](
            self.rule_name, sudocmdgroup=self.test_sudodenycmdgroup
        )
        entry = api.Command["sudorule_show"](self.rule_name)["result"]
        assert_attr_equal(entry, "cn", self.rule_name)
        assert_attr_equal(entry, "memberuser_user", self.test_user)
    ...
    def test_l_1_sudorule_rename(self):
        ...
        """
        api.Command["sudorule_mod"](self.rule_name, rename=self.rule_renamed)
        ...
        api.Command["sudorule_mod"](self.rule_renamed, rename=self.rule_name)
