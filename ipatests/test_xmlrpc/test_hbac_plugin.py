...
class test_hbac(XMLRPC_test):
    ...
    def test_1_hbacrule_add(self):
        ...
        with pytest.raises(errors.DuplicateEntry):
            api.Command["hbacrule_add"](self.rule_name, accessruletype=self.rule_type)
    ...
    def test_7_hbacrule_init_testing_data(self):
        ...
        self.failsafe_add(
            api.Object.hbacsvc, self.test_service, description=u"desc",
        )
    ...
    def test_l_hbacrule_add(self):
        ...
        with pytest.raises(errors.ValidationError):
            api.Command["hbacrule_add"](
                u"denyrule", accessruletype=u"deny", description=self.rule_desc,
            )
    ...
    def test_o_hbacrule_rename(self):
        ...
        """
        api.Command["hbacrule_mod"](self.rule_name, rename=self.rule_renamed)
        ...
        api.Command["hbacrule_mod"](self.rule_renamed, rename=self.rule_name)
    ...
    def test_y_hbacrule_zap_testing_data(self):
        ...
        api.Command["hbacrule_remove_host"](
            self.rule_name, hostgroup=self.test_hostgroup
        )
    ...
    def test_zz_hbacrule_add_with_deprecated_option(self):
        ...
        """
        with pytest.raises(errors.ValidationError):
            api.Command["hbacrule_add"](self.rule_name, sourcehostcategory=u"all")
