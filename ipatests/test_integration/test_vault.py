...
class TestInstallKRA(IntegrationTest):
    ...
    shared_vault_name_replica_without_KRA = (
        "ci_test_shared" "_vault_replica_without_kra"
    )
    ...
    def test_create_and_retrieve_shared_vault_replica_without_kra(self):
        ...
        self.replicas[0].run_command(["kinit", self.vault_user], stdin_text=user_kinit)
    ...
    def test_create_and_retrieve_vault_replica_with_kra(self):
        ...
        self._retrieve_secret(
            [self.vault_name_master, self.vault_name_replica_without_KRA,]
        )
