...
class TestUninstallBase(IntegrationTest):
    ...
    def test_uninstall_client_invalid_hostname(self):
        ...
        tasks.install_client(
            self.master, client, extra_args=["--hostname", client_inv_hostname]
        )
        ...
        result = client.run_command(["ls", restore_state_path], raiseonerr=False)
    ...
    def test_install_uninstall_replica(self):
        ...
        tasks.install_replica(
            self.master, self.replicas[0], extra_args=["--force-join"]
        )
    ...
    def test_failed_uninstall(self):
        ...
        try:
            ...
            self.master.run_command([paths.DSCTL, serverid, "remove", "--do-it"])
