...
DEFAULT_CONFIG = (
    ...
    (
        ...
        DN(("cn", "applications"), ("cn", "configs"), ("cn", "policies")),
    ),
    (
        "container_policygroups",
        DN(("cn", "policygroups"), ("cn", "configs"), ("cn", "policies")),
    ),
    (
        "container_policylinks",
        DN(("cn", "policylinks"), ("cn", "configs"), ("cn", "policies")),
    ),
    ...
    (
        "container_dna_posix_ids",
        DN(("cn", "posix-ids"), ("cn", "dna"), ("cn", "ipa"), ("cn", "etc")),
    ),
    (
        "container_realm_domains",
        DN(("cn", "Realm Domains"), ("cn", "ipa"), ("cn", "etc")),
    ),
...
# regexp definitions
PATTERN_GROUPUSER_NAME = "(?!^[0-9]+$)^[a-zA-Z0-9_.][a-zA-Z0-9_.-]*[a-zA-Z0-9_.$-]?$"
...
# Use cache path
USER_CACHE_PATH = os.environ.get("XDG_CACHE_HOME") or os.path.expanduser("~/.cache")
