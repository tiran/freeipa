...
class cert_get_requestdata(Local):
    ...
    takes_options = (
        ...
        Str("out?", doc=_("Write CertificationRequestInfo to file"),),
    )
    ...
    has_output_params = Str(
        "request_info", label=_("CertificationRequestInfo structure"),
    )
    ...
    def execute(self, *args, **options):
        ...
        request_info = base64.b64encode(
            csrgen_ffi.build_requestinfo(csr_config.encode("utf8"), public_key_info)
        )
