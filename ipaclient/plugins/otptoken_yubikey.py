...
class otptoken_add_yubikey(Command):
    ...
    takes_options = (
        IntEnum("slot?", cli_name="slot", label=_("YubiKey slot"), values=(1, 2),),
    )
    ...
    def forward(self, *args, **kwargs):
        ...
        try:
            ...
            raise NotFound(
                reason=str(e) + ". Please install 'libyubikey' "
        ...
        cfg.mode_oath_hotp(
            key,
            kwargs.get("ipatokenotpdigits", self.get_default_of("ipatokenotpdigits")),
        )
